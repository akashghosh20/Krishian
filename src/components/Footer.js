...
const Footer = () => {
  return (
    <footer className="bg-krishian-dark text-white py-16">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-3" aria-label="Social media links">
              <a
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center bg-white/5 hover:bg-white/10 ring-1 ring-white/10 hover:ring-white/30 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
              >
