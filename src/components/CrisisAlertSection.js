    ...
    <section ref={sectionRef} className="py-24 bg-gradient-to-br from-krishian-white to-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0" style={{
          backgroundImage: `radial-gradient(circle at 20% 20%, rgba(160,199,82,0.08) 0%, transparent 50%),
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center bg-krishian-green/10 text-krishian-dark px-6 py-3 rounded-pill text-sm font-medium mb-6 animate-pulse">
            <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
            </svg>
            <span className="font-semibold">CRITICAL: Bangladesh Agriculture Crisis</span>
          </div>
        </motion.div>
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold text-krishian-dark mb-6">
            The Hidden Crisis in
          </h1>
          <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-krishian-green to-krishian-blue bg-clip-text text-transparent mb-8">
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            ...
            <span className="block mt-4 text-2xl font-bold text-krishian-green">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {crisisStats.map((stat, index) => (
            ...
            >
              <div className="bg-white rounded-card p-8 shadow-card hover:shadow-glow transition-all duration-300 border border-gray-100 group-hover:border-krishian-green/30 group-hover:-translate-y-2 relative overflow-hidden">
                {/* Animated Background */}
                <div className="absolute inset-0 bg-gradient-to-r from-krishian-green/5 to-krishian-blue/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                
                <div className="relative z-10">
                  {/* Icon */}
                  <div className="w-16 h-16 bg-gradient-to-br from-krishian-green/15 to-krishian-blue/15 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    <span className="text-3xl">{stat.icon}</span>
            </div>

                  {/* Value */}
                  <div className="text-4xl font-bold text-gray-800 mb-2 group-hover:text-krishian-green transition-colors duration-300">
                  ...
                  {/* Label */}
                  <h3 className="text-xl font-semibold text-gray-800 mb-2 group-hover:text-krishian-green transition-colors duration-300">
                    {stat.label}
                  </h3>
                  ...
                  <div className="flex items-center justify-center mt-4 text-sm text-gray-500">
                    <div className="w-2 h-2 bg-krishian-green rounded-full mr-2 animate-pulse"></div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-card border border-red-100 relative overflow-hidden">
            ...
            <div className="relative z-10">
                  ...
                  >
                    ...
                    {index < steps.length - 1 && (
                      <div className="hidden md:flex items-center justify-center mt-4">
                        <div className="w-8 h-0.5 bg-gradient-to-r from-krishian-green to-krishian-blue relative">
                          <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-0 h-0 border-l-4 border-l-krishian-green border-t-2 border-b-2 border-t-transparent border-b-transparent"></div>
                        </div>
            </div>
                    )}
                  </motion.div>
              ...
              <div className="mt-8 text-center">
                <div className="inline-flex items-center bg-krishian-green/10 text-krishian-dark px-6 py-3 rounded-pill text-sm font-medium">
        ...
        <motion.div 
          ...
          transition={{ duration: 0.8 }}
        >
          <div className="bg-gradient-to-r from-krishian-green to-krishian-blue rounded-2xl p-12 text-krishian-white relative overflow-hidden">
            {/* Background Pattern */}
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-krishian-white text-krishian-dark font-semibold px-8 py-4 rounded-card hover:bg-gray-100 transition-all duration-300 transform hover:scale-105">
                  Stop the Crisis
                </button>
                <button className="border-2 border-krishian-white text-krishian-white font-semibold px-8 py-4 rounded-card hover:bg-krishian-white hover:text-krishian-dark transition-all duration-300 transform hover:scale-105">
                  Learn More
                </button>
              </div>
            </div>
