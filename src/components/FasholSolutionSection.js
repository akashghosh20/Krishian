  ...
  return (
    <section ref={sectionRef} className="py-24 bg-gradient-to-br from-krishian-white to-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-r from-krishian-green/10 via-transparent to-krishian-blue/10"></div>
        ...
        {/* Floating Elements */}
        <div className="absolute top-20 left-10 w-16 h-16 bg-krishian-green/10 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute top-40 right-20 w-20 h-20 bg-krishian-blue/10 rounded-full blur-xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-20 left-1/4 w-16 h-16 bg-krishian-green/10 rounded-full blur-xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center bg-gradient-to-r from-krishian-green/15 to-krishian-blue/15 px-8 py-4 rounded-full border border-krishian-green/30 mb-8">
            <div className="w-3 h-3 bg-krishian-green rounded-full mr-3 animate-pulse"></div>
            <span className="text-krishian-dark font-semibold text-sm">Krishian Solution</span>
        </div>

          <h2 className="text-6xl md:text-7xl font-bold mb-8">
            <span className="text-krishian-dark">
              The Future of
            </span>
            <br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {solutionFeatures.map((feature, index) => (
              ...
              >
                ...
                {/* Feature Card */}
                <div className={`relative z-10 bg-krishian-white border-krishian-green/20 border-2 rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 hover:scale-105 group-hover:border-opacity-50`}>
                  {/* Step Number */}
                  ...
                  {/* Content */}
                  <h3 className={`text-2xl font-bold text-krishian-dark mb-4 group-hover:text-krishian-green transition-colors duration-300`}>
                    {feature.title}
                  </h3>
                  ...
                  <div className="space-y-2">
                    {feature.benefits.map((benefit, benefitIndex) => (
                      <div key={benefitIndex} className="flex items-center text-sm text-gray-700">
                        <div className={`w-2 h-2 bg-gradient-to-r from-krishian-green to-krishian-blue rounded-full mr-3`}></div>
                        {benefit}
              </div>
                    ))}
              </div>
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-4xl font-bold text-krishian-dark mb-4">
              Measurable Impact
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {impactMetrics.map((metric, index) => (
              ...
              >
                ...
                <div className="text-5xl font-bold text-black mb-2 group-hover:text-emerald-300 transition-colors duration-300">
                  {metric.metric}
                </div>
